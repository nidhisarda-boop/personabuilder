...
INDUSTRY_RE = {
    "tech":        r"software|engineer|developer|devops|data scien|ml |ai |cloud|aws|gcp|azure|python|java|react|node|kubernetes|backend|frontend|full.?stack",
    "healthcare":  r"nurse|rn |lpn |physician|clinical|icu|er |surgery|hospital|health|medical|patient care|bsn|adn|cna",
    "logistics":   r"warehouse|fulfillment|distribution|logistics|driver|forklift|picker|packer|shipping|freight",
    "retail":      r"retail|store associate|cashier|sales associate|customer service|shift manager",
    "hospitality": r"restaurant|hotel|hospitality|server|cook|chef|front desk|housekeeping",
    "finance":     r"finance|fintech|banking|trading|accounting|cpa |audit|wealth management",
    "defense":     r"defense|clearance|secret |ts\/sci|missile|radar|military|dod|darpa|hypersonic|ballistic",
}
